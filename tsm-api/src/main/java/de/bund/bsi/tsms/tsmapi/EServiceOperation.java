...
public enum EServiceOperation {
     ...
     * {@link de.bund.bsi.tsms.tsmapi.parameters.IInstallServiceCommand} as last
     * serviceCommand and finalize false.
     */
    SERVICE_DEPLOYMENT_INSTALLATION(10),
    /**
     * Operation is a {@link ITsmApiService#deployService} method call with
     * {@link de.bund.bsi.tsms.tsmapi.parameters.IPersonalizeServiceCommand} as last
     * serviceCommand and finalize false.
     */
    SERVICE_DEPLOYMENT_PERSONALIZATION(11),
    /**
     * Operation is a {@link ITsmApiService#deployService} method call with
     * {@link de.bund.bsi.tsms.tsmapi.parameters.IActivateServiceCommand} as last
     * serviceCommand and finalize false.
     */
    ...
    /**
     * Operation is a {@link ITsmApiService#updateService} method call with
     * {@link de.bund.bsi.tsms.tsmapi.parameters.IPersonalizeServiceCommand} command
     * as last serviceCommand and finalize false.
     */
