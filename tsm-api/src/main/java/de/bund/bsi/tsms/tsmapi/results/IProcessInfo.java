 ...
 * {@link de.bund.bsi.tsms.tsmapi.ITsmApiService#deployService}</li>
 * <li>{@link IUpdateServiceResult#getProcessInfo()} from
 * {@link de.bund.bsi.tsms.tsmapi.ITsmApiService#updateService}</li>
 * <li>{@link ISuspendOrResumeResult#getProcessInfo()} from
 * {@link de.bund.bsi.tsms.tsmapi.ITsmApiService#suspendOrResumeService}</li>
 * <li>{@link ITerminateServiceResult#getProcessInfo()} from
 * {@link de.bund.bsi.tsms.tsmapi.ITsmApiService#terminateService}</li>
 * </ul>
 *
 * @since 1.0
 */
