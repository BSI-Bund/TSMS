...
public enum EServiceInstanceState {
     ...
     * execution of the {@link de.bsi.tsms.tsmapi.parameters.IInstallServiceCommand}
     * of a {@link ITsmApiService#deployService} or
     * {@link ITsmApiService#updateService} function call has finished. In this
     * state the loading and installing of all Service components as defined by the
     * SP has been performed.
     */
    INSTALLED(11),
    /**
     * A Service Instance reaches the optional UnderDeployment:Personalized state
     * when the execution of the last
     * {@link de.bsi.tsms.tsmapi.parameters.IPersonalizeServiceCommand} of a
     * {@link ITsmApiService#deployService} or {@link ITsmApiService#updateService}
     ...
     * {@link de.bsi.tsms.tsmapi.parameters.IActivateServiceCommand} of a
     * {@link ITsmApiService#deployService} or {@link ITsmApiService#updateService}
     ...
     * {@link de.bsi.tsms.tsmapi.parameters.IActivateServiceCommand} with
     ...
     */
    EServiceInstanceState(final int number) {
        this.number = number;
    }
