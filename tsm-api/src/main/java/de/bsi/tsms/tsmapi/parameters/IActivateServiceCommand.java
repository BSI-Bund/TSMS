 ...
 * {@link de.bsi.tsms.tsmapi.EServiceInstanceState#ACTIVATED} state.<br>
 * Depending on the value of suspensionControl, the Service instance reaches
 * either {@link de.bsi.tsms.tsmapi.EServiceInstanceState#OPERATIONAL} or
 * {@link de.bsi.tsms.tsmapi.EServiceInstanceState#SUSPENDED} once the
...
public interface IActivateServiceCommand extends IServiceCommand {
     ...
     * {@link de.bsi.tsms.tsmapi.EServiceInstanceState#OPERATIONAL} or
     * {@link de.bsi.tsms.tsmapi.EServiceInstanceState#SUSPENDED} after the
